...
module API.Client {
    ...
    export class DocumentsApi {
         ...
         */
        public getDocuments (indexName: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<GetDocumentsResponse> {
         ...
         * @param indexName Index name
         */
        public getDocumentsHandled (indexName: string, extraHttpRequestParams?: any ) : ng.IPromise<GetDocumentsResponse> {
